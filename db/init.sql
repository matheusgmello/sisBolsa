-- ============================================================
-- SisBolsa - Script Principal de Inicialização
-- Este arquivo carrega por padrão o Seed de Apresentação (cenário enxuto).
-- Para alternar para o seed completo, utilize o arquivo db/init_completo.sql
-- ============================================================
